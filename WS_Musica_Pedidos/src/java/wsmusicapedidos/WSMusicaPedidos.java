...
public class WSMusicaPedidos {
    ...
    */
    ...
    @Oneway
    @WebMethod(operationName = "restockLista")
    public void restockLista(@WebParam(name = "lista_it") List<ClsItem> lista_it) 
    { for(ClsItem item : lista_it)
        productFacade.restockProduct(item.getId_prod(),item.getCantidad());
    }
    ...
    @Oneway
    @WebMethod(operationName = "updateStatusLista")
    public void updateStatusLista(@WebParam(name = "lista_it") List<ClsItem> lista_it,
                                    @WebParam(name = "status") String status) 
    { for(ClsItem item : lista_it)
        orderedProductFacade.updateOrderedProductStatus(item.getId_prod(),item.getCantidad(), status);
    }
    ...
    public void procesarBackorders(@WebParam(name = "numPedido") int numPedido,
        ...
        for (entidades.Backorder backorder : backorderList) {
            ...
            orderedProductFacade.updateOrderedProductStatus(numPedido, backorder.getProductId(), "B");
        }
